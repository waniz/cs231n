...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None, reg=0.0):
        ...
        fully_connected_1 = np.dot(X, W1) + b1

        relu_1 = fully_connected_1
        relu_1[relu_1 < 0] = 0

        fully_connected_2 = np.dot(relu_1, W2) + b2

        scores = fully_connected_2
        ...
        softmax_scores = np.exp(shift_scores) / np.sum(np.exp(
            shift_scores), axis=1)[..., np.newaxis]
        ...
        dScore[range(N), y] = dScore[range(N), y] - 1
        dScore /= N
